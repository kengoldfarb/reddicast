							...
							<div className='px-4 pt-5 pb-4 sm:p-6 sm:pb-4 bg-th-base'>
								<div className='sm:flex sm:items-start'>
									<div className='flex items-center justify-center flex-shrink-0 w-12 h-12 mx-auto rounded-full sm:mx-0 sm:h-10 sm:w-10 '>
										<MdErrorOutline className='w-6 h-6 text-th-red' aria-hidden='true' />
									</div>
									<div className='mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left'>
										<Dialog.Title as='h3' className='text-lg font-medium leading-6 text-th-text'>
											Login Needed
										</Dialog.Title>
										<div className='mt-3'>
											<p className='text-sm text-th-text opacity-80'>
												A login is required to vote and access additional features. You can login with your Reddit
												account below.
											</p>
										</div>
									</div>
