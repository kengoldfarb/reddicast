				...
				{clearingSeen ? (
					...
					<div className={`${buttonStyle} flex flex-col items-center justify-between relative`}>
						...
						<div className='flex justify-center w-full gap-3'>
							...
							<button aria-label='no' className='hover:underline' onClick={() => setSeenPrompt(false)}>
								No
							</button>
						</div>
					</div>
					...
					<div className='relative'>
						<button aria-label='clear seen' className={buttonStyle} onClick={() => setSeenPrompt(true)}>
							Clear Seen
						</button>
						{seenErr && (
				...
				{clearingRead ? (
					...
					<div className={`${buttonStyle} flex flex-col items-center justify-between relative`}>
						...
						<div className='flex justify-center w-full gap-3'>
							...
							<button aria-label='no' className='hover:underline' onClick={() => setReadPrompt(false)}>
								No
							</button>
						</div>
					</div>
					...
					<div className='relative'>
						<button aria-label='clear read' className={buttonStyle} onClick={() => setReadPrompt(true)}>
							Clear Read
						</button>
						{readErr && (
							<div className='absolute -bottom-[14px] text-center text-th-red text-[8px] w-full'>
