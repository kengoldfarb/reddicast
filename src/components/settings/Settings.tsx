...
const Settings = () => {
	...
	const [categories] = useState({
		...
		Media: {
			...
			settings: [
				...['disableEmbeds', 'preferEmbeds', 'embedsEverywhere', 'autoplay', 'hoverplay', 'audioOnHover', 'nsfw'].map(
					(s: any) => (
						<Toggles
							key={s}
							setting={s}
		...
		Behavior: {
			...
			settings: [
				...
				...['slowRefreshInterval', 'fastRefreshInterval'].map((s: any) => <IntInput key={s} setting={s} />),
	...
	return (
		...
		>
			<h1 className='absolute ml-0.5 mr-auto text-xl font-semibold -top-10'>Settings</h1>
			<Tab.List
				className={
