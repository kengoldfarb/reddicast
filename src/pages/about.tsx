		...
		<div className='h-screen mx-4 -mt-16'>
			...
			<div className='h-full text-justify text-th-text '>
				<div className='flex flex-col justify-center max-w-xl min-h-full gap-4 mx-auto space-y-1 overflow-y-scroll scrollbar-none '>
					...
					<p className=''>
						This is an independent site not affiliated with Reddit. All content on this site is retrieved from the
						public Reddit API.
					</p>
					...
					<p className=''>
						...
						or contact me at{' '}
						<a className={link} href='mailto: trodditdev@gmail.com'>
							trodditdev@gmail.com
						</a>{' '}
						for anything else.
					</p>
					<p className=''>
						<Link href={'/changelog'} className='flex flex-wrap justify-between pt-5 font-semibold hover:underline'>
							<h4>v{VERSION}</h4>
							<h4>See Changelog</h4>
						</Link>
					</p>
